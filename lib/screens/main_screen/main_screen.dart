    ...
    return Material(
      ...
      child: Stack(
        children: [
          Positioned.fill(
            left: _menuWidth,
            top: windowsBar.preferredSize.height,
            child: _pageWidget(),
          ),
          Positioned.fill(
            top: windowsBar.preferredSize.height,
...
class _WindowBar extends StatelessWidget implements PreferredSizeWidget {
  const _WindowBar();
              ...
              Expanded(
                child: MoveWindow(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.only(left: kGridSeparator * 2),
                    child: Text(
                      'Genshin Tracker',
